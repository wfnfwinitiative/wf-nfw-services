...
# UPDATE FEATURE FLAG
# ============================================
@router.patch("/{feature_flag_name}", response_model=FeatureFlagRead, dependencies=[Depends(require_roles(["ADMIN"]))])
...
# DELETE FEATURE FLAG
# ============================================
@router.delete("/{feature_flag_name}", dependencies=[Depends(require_roles(["ADMIN"]))])
